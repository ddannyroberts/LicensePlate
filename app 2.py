...
def dashboard():
    ...
    return render_template('dashboard.html', plates=plates, username=session['username'])
...
def admin_dashboard():
    ...
    return render_template('admin_dashboard.html', plates=plates, access_logs=access_logs, authorized_vehicles=authorized_vehicles)
